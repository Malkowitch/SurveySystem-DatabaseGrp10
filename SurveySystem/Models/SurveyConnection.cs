namespace SurveySystem.Models
{
    ...
    public class SurveyConnection : DbContext
    {
        ...
        public virtual DbSet<Question> QueestionDB { get; set; }
        public virtual DbSet<MultiOption> MultiOptionDB { get; set; }
        public virtual DbSet<InputType> InputTypeDB { get; set; }
    }
}